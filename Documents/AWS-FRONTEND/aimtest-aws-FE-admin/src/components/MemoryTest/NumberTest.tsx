...
import {
  ...
  postNumberTestRange,
  putNumberTestRange,
} from 'redux/action/Test/NumberTest';
...
import { getNumberTestLevels } from 'redux/action/Level/NumberTest';
...
const NumberTest = () => {
  ...
  const testData = useSelector(
    (state: RootState) => state?.numberTest?.numberTestData?.numberTests
  );
  const load = useSelector((state: RootState) => state?.loader?.loader);
  const numberOfRecord = useSelector(
    (state: RootState) => state?.numberTest?.numberTestData?.numberOfRecord
  );
  ...
  const numberTestLevel = useSelector(
    (state: RootState) =>
  ...
  const initialValues: numberTestRange = {
    numberTestDetail:
      todo === 'edit'
        ? editData
        : [
  ...
  const levelListOptions = (digit: number, index: number) => {
    const filteredList = numberTestLevel?.filter(
          ...
          <div className={cx('text-btn')}>
            <Formik
              ...
              onSubmit={(values, { resetForm }) => {
                if (todo === 'edit') {
                  ...
                  dispatch(
                    putNumberTestRange(
                      values.numberTestDetail[0]._id as string,
                      values.numberTestDetail[0] as rangeData,
                      token,
                      setDisplay,
                      resetForm
            ...
            >
              {({
                ...
                <>
                  <RestoreLevelModal
                    title='Restore Number Test'
                    modalName='Number Test'
                    restoreId={restore}
                    resetForm={resetForm}
                    navigate={setDisplay}
                    content='Number Test Exist But Soft Deleted. Do You Want To Restore The Data'
                    show={restoreLevel}
                        ...
                        <div className={cx('card')}>
                          <div className={cx('card-table')}>
                            <div className=''>
                              ...
                              {/* <h6 className={cx('test-back')}>Number Test</h6> */}
                            </div>
                            <FieldArray
                              name='numberTestDetail'
                              render={(arrayHelpers) => (
                                <div className='table-height border-0'>
                                  {values?.numberTestDetail?.map(
                                      ...
                                      <div key={index}>
                                        <div className='row'>
                                          <div className='col'>
                                            ...
                                            <SelectField
                                              name={`numberTestDetail[${index}].class.name`}
                                              options={classList(classData)}
                                              placeholder='Select Class'
                                              value={
                                                values?.numberTestDetail[index]
                                                  ?.class?.name
                                              }
                                              onChange={(e) =>
                                                setFieldValue(
                                                  `numberTestDetail[${index}].class`,
                                                  e &&
                                              ...
                                              touched={
                                                touched.numberTestDetail !==
                                                  undefined &&
                                                touched?.numberTestDetail[index]
                                                  ?.class?.name
                                              }
                                            />
                                          </div>
                                          <div className='col'>
                                            ...
                                            <div className='row'>
                                              <div className='col pe-0'>
                                                <SelectField
                                                  name={`numberTestDetail[${index}].from.level`}
                                                  options={numberTestLevel
                                                    ?.map(
                                                      (item: {
                                                        level: number;
                                                        _id: string;
                                                  ...
                                                  isSearchable={false}
                                                  value={
                                                    values?.numberTestDetail[
                                                      index
                                                    ]?.from?.level as string
                                                  }
                                                  onChange={(e) => {
                                                    setFieldValue(
                                                      `numberTestDetail[${index}].to`,
                                                      {
                                                        level: '',
                                                        _id: '',
                                                      }
                                          ...
                                          <div className='col'>
                                            ...
                                            <div className='row'>
                                              <div className='col pe-0'>
                                                <SelectField
                                                  name={`numberTestDetail[${index}].to.level`}
                                ...
                                <div>
                                  <div className={cx('card-flex')}>
                                    <ol className='cd-breadcrumb'>
                                      ...
                                      <li className='current'>Number Test</li>
                                    </ol>
                                  </div>
